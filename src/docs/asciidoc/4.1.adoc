...
* Introduced a packet flag to distinguish between the connections of
members having the same Hazelcast version and different versions.
https://github.com/hazelcast/hazelcast/pull/17756[#17756]
...
* Added the derivation of result types for aggregate `SUM` and `AVG`
operations in the SQL engine.
https://github.com/hazelcast/hazelcast/pull/17669[#17669]
